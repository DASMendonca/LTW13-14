...
<div class="update_div" name="Customer" id="true">
		...
		<form action="updateMyuser.php" method="post" class="update_form" name="CustomerID" id="'.$_SESSION['customer']->CustomerID.'">
			<fieldset>
				...
				<input type="text" name="AddressDetail" id="AddressDetail" placeholder="'.$_SESSION['customer']->getAddress()->AddressDetail.'" value="'.$_SESSION['customer']->getAddress()->AddressDetail.'"><br>
				</div>
